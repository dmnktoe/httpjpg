import { Box, Button, CustomCursor, Headline, Link, Paragraph } from "@httpjpg/ui";
import type { Meta, StoryObj } from "@storybook/react";

import { OPTIMIZED_IMAGES } from "../shared/storybook-fixtures";

/**
 * Replaces the pointer. Hover a `[data-cursor]` host to show its label.
 */
const meta = {
    ...
    <>
      ...
      <Box css={{ maxW: "800px", mx: "auto" }}>
        ...
        <Paragraph css={{ mt: "24px", mb: "32px" }}>
          Move your mouse around to see the custom cursor in action. Hover over interactive elements
          to see the cursor respond.
        </Paragraph>
        ...
        <Paragraph>
          The cursor uses mix-blend-mode for a brutalist look and responds to all interactive
  ...
  render: (args) => (
    <>
      ...
      <Box css={{ maxW: "800px", mx: "auto" }}>
        ...
        <Paragraph css={{ mt: "24px", mb: "32px" }}>Clean cursor without hover labels.</Paragraph>
  ...
  render: (args) => (
    <>
      ...
      <Box css={{ maxW: "800px", mx: "auto" }}>
        ...
        <Paragraph css={{ mt: "24px", mb: "32px" }}>
          Hover over the links below to see work preview images follow your cursor.
        </Paragraph>
