...
/**
 * 12-column grid. Pair with `GridItem` for span, start, and overlap.
 */
const meta = {
  title: "Layout/Grid",
  component: Grid,
  ...
  argTypes: {
    ...
    align: {
      ...
      description: "Vertical alignment of items in their grid areas (alignItems)",
      table: {
  ...
  render: (args) => (
    <Grid {...args} css={{ p: "16 8", bg: "white" }}>
      ...
      <GridItem colSpan={5} colStart={2} css={{ mt: "24", pr: "8" }}>
        <Paragraph size="sm">
          ⋆.˚ ᡣ𐭩 Overlapping elements create depth and visual hierarchy. Strategic layering draws
          attention to key content ･ﾟ⋆
        </Paragraph>
      </GridItem>
      ...
      <GridItem colSpan={5} colStart={8}>
        <Box style={{ padding: "2rem", borderLeft: "4px solid black" }}>
          ...
          <Paragraph style={{ marginTop: "1rem", fontSize: "0.875rem" }}>
            Complex grids enable sophisticated editorial designs with varying column spans.
          </Paragraph>
        </Box>
      </GridItem>
