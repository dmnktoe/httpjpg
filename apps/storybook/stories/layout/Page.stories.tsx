...
/**
 * Full-page shell with header and footer slots. Used by Storyblok page bloks.
 */
const meta = {
  title: "Layout/Page",
  component: Page,
  ...
  render: (args) => (
    <Page {...args}>
      <Section>
        ...
        <Paragraph>
          This is a demo page showcasing the Page component with Header and Footer. The layout is
          designed to be Storyblok-compatible for future CMS integration.
        </Paragraph>
        <Paragraph>
  ...
  render: (args) => (
    <Page {...args}>
      ...
      <Section css={{ py: "24" }}>
        ...
        >
          <Box css={{ p: "6", border: "1px solid", borderColor: "neutral.300" }}>
  ...
  render: (args) => (
    <Page {...args}>
      <Section css={{ py: "32" }}>
        ...
        <Paragraph>This page only includes the header navigation. Footer is omitted.</Paragraph>
      </Section>
    </Page>
  ),
};
  ...
  render: (args) => (
    <Page {...args}>
      <Section css={{ py: "32" }}>
        ...
        <Paragraph>This page only includes the footer. Header is omitted.</Paragraph>
      </Section>
    </Page>
  ),
};
  ...
  render: () => (
    <Page>
      <Section css={{ py: "32" }}>
        ...
        <Paragraph>
          This page has no header or footer. Perfect for embedded content or special layouts.
        </Paragraph>
      </Section>
    </Page>
  ),
