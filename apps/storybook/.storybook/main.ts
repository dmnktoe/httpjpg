    ...
    return mergeConfig(config, {
      ...
      resolve: {
        alias: {
          ...
          "@httpjpg/consent/catalog": path.resolve(consentPackagePath, "src/types.ts"),
          "@httpjpg/consent/utils": path.resolve(consentPackagePath, "src/utils.ts"),
      ...
      optimizeDeps: {
        ...
        exclude: ["@httpjpg/ui", "@httpjpg/consent"],
      },
      server: {
        fs: {
          allow: [rootPath],
