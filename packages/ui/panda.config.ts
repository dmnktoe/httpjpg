    ...
    css: [
      {
        ...
        properties: {
          ...
          alignSelf: CMS_OPTIONS.alignItems,
          justifyItems: CMS_OPTIONS.justifyItems,
          justifySelf: CMS_OPTIONS.justifyItems,
          ...
          margin: CMS_OPTIONS.margin,
          marginTop: CMS_OPTIONS.margin,
          marginBottom: CMS_OPTIONS.margin,
          marginLeft: CMS_OPTIONS.margin,
          marginRight: CMS_OPTIONS.margin,
          ...
          gridAutoFlow: [...CMS_OPTIONS.gridFlow, "row dense", "column dense"],
          ...
          maxWidth: [
            ...
            "1536px",
            "100%",
            ...CMS_OPTIONS.proseMaxWidth.filter((value) => value !== "none"),
          ],
