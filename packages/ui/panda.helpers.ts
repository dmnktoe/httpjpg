/**
 * Build-time color helpers consumed by panda.config.ts to compose static
 * gradients/rgba values. Not exported from the runtime package — the
 * generated styled-system already contains the resolved CSS.
 */
