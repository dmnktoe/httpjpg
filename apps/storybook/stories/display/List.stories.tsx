...
export const UnorderedBasic: Story = {
  render: () => (
    <UnorderedList>
      <ListItem>
        Konzeption, Moderation, Organisation und Durchführung eines Radioprojekts.
      </ListItem>
      <ListItem>Verantwortlich für Planung, Programminhalte und Teamkoordination.</ListItem>
      <ListItem>Betreuung einer Praktikantin (Leitungs- & Mentoringerfahrung).</ListItem>
    </UnorderedList>
  ),
};
