...
export const mediaBlocks: BlockDef[] = [
  ...
  {
    name: "scroll_clip_image",
    display_name: "Scroll Clip Image",
    group: "Media",
    icon: "block-image",
    color: "#38b2ac",
    preview_field: "alt",
    schema: withSpacing({
      ...
      ...tabbed("Reveal", "reveal", {
        pin: field.boolean("Pin at viewport center"),
        pinDistance: field.text("Pin Distance (only when Pin is on, e.g. 100vh)", {
          default_value: "100vh",
        }),
        maxClipRatio: field.number("Max Clip Ratio (%)", { default_value: "10" }),
        maxScale: field.number("Max Scale", { default_value: "1.1" }),
        brackets: field.boolean("ASCII Corner Brackets", "true"),
        showProgress: field.boolean("Pinned: Show Progress Label", "true"),
      }),
    }),
  },
  {
