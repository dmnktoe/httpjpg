...
const meta = {
  ...
  argTypes: {
    as: {
      ...
      options: ["div", "section", "article", "aside", "header", "footer", "main", "nav"] as const,
    ...
    children: (
      <div>
        ...
        <Paragraph style={{ marginTop: "0.5rem" }}>
          A simple container with custom styling. Change the "as" control to render different
...
export const OldBasic: Story = {
  render: () => (
    ...
    >
      <Headline level={3}>Box Component</Headline>
      <Paragraph style={{ marginTop: "0.5rem" }}>A simple container with custom styling.</Paragraph>
    </Box>
  ),
};
...
export const SemanticElements: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      >
        <Paragraph style={{ fontSize: "0.875rem" }}>Footer Element - © 2025</Paragraph>
      </Box>
    </div>
  ),
};
  ...
  render: () => (
    ...
    >
      ...
      >
        ...
        <Headline level={3} style={{ margin: 0, fontSize: "1.25rem", fontWeight: 600 }}>
          🎀 ୧ꔛꗃ˖ PROJECT TITLE ･ﾟ⋆
        </Headline>
        <Paragraph
          style={{
        ...
        >
          ⋆.˚ ᡣ𐭩 .𖥔˚ Bold design with modern aesthetics. Perfect for portfolio items ⋆.˚✮
        </Paragraph>
        <Box
          style={{
            marginTop: "1rem",
  ...
  render: () => (
    ...
    >
      {Array.from({ length: 6 }).map((_, i) => (
        ...
        >
          <Headline level={3} style={{ color: i % 2 === 0 ? "white" : "black", margin: 0 }}>
            Box {i + 1}
          </Headline>
        </Box>
      ))}
