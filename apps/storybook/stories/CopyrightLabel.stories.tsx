import { Box, CopyrightLabel, Image } from "@httpjpg/ui";
import type { Meta, StoryObj } from "@storybook/react";

const SAMPLE_IMAGE = "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800";

const POSITION_OPTIONS = ["below", "overlay", "inline-black", "inline-white"] as const;

const meta = {
  title: "UI/CopyrightLabel",
...
export const Overlay: Story = {
  ...
  render: (args) => (
    <Box css={{ position: "relative", width: "400px", aspectRatio: "16/9", overflow: "hidden" }}>
      <Image src={SAMPLE_IMAGE} alt="Sample" />
      <CopyrightLabel {...args} />
    </Box>
  ),
};
