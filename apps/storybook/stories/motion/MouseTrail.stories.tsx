...
/**
 * ASCII particles that follow the pointer. Honors `prefers-reduced-motion`.
 */
const meta = {
  ...
  render: (args) => (
    <Box>
      ...
      >
        ...
        <Paragraph size="lg">Watch the ASCII trail follow your cursor around the screen.</Paragraph>
      </Box>
    </Box>
  ),
};
        ...
        <Box css={{ maxW: "4xl", mx: "auto" }}>
          ...
          <Box css={{ display: "grid", gap: "12" }}>
            <Box>
              ...
              <Paragraph size="lg">
                Move your mouse around to see the interactive ASCII trail effect. This creates a
                brutalist, playful interaction layer that doesn't interfere with content
                readability.
              </Paragraph>
            </Box>
            ...
            <Box>
              ...
              <Box css={{ display: "grid", gap: "4" }}>
                ...
                >
                  ...
                  <Paragraph>Photography series exploring urban spaces</Paragraph>
                </Box>
                <Box
                  css={{
                    p: "6",
