...
/**
 * Work shaped the way the CMS delivers it: `tagValues` are what Storyblok
 * stores, and the labels are resolved through the same catalog the site uses,
 * so a story can never show a tag the vocabulary does not have.
 */
