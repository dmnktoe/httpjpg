...
/**
 * Credit line used by Image, Video, ScrollClipImage, and Lightbox.
 * Prepends © unless the string already starts with it. `source` is a second
 * line. Inline positions rotate the text onto the image's corner.
 */
const meta = {
