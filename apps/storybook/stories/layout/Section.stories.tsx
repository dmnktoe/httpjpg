...
/**
 * Semantic `<section>` with token spacing on each edge (`pt` / `pb` / …).
 */
const meta = {
...
export const Basic: Story = {
  ...
  render: (args) => (
    ...
    >
      ...
      <Paragraph css={{ mt: "4" }}>
        This is a basic section with configurable padding. Use the controls to adjust spacing and
        see how it affects the layout. Try changing containerSize to "fluid" to see the difference.
      </Paragraph>
    </Section>
  ),
};
  ...
  args: {
    ...
    children: (
      <Container>
        ...
        <Paragraph css={{ mt: "2" }}>Minimal padding for compact layouts.</Paragraph>
      </Container>
    ),
  },
};
      ...
      <Section pt={24} pb={24} style={{ background: "white" }}>
        <Container>
          ...
          <Paragraph style={{ marginTop: "1rem" }}>
            White background section with standard spacing. Perfect for main content areas.
          </Paragraph>
        </Container>
      </Section>
      ...
      <Container>
        ...
        >
          ...
          <Box style={{ flex: 1, paddingTop: "1rem" }}>
            ...
            >
              ⋆.˚ ᡣ𐭩 A collection of modern design work showcasing bold typography, strong visual
              hierarchy, and clean aesthetics ⋆.˚✮
            </Paragraph>
          </Box>
        </Box>
  ...
  args: {
    ...
    children: (
      <>
        ...
        <Paragraph css={{ mt: "4" }}>
          This section uses a fluid container that spans the full width. Compare this to the Basic
          story with a 2xl container to see the difference.
        </Paragraph>
        <Box
          css={{
            mt: "8",
  ...
  args: {
    ...
    children: (
      <Box css={{ px: "4" }}>
        ...
        <Paragraph css={{ mt: "4" }}>
          This section has useContainer=false, so you have full control over the content layout.
          You'll need to add your own Container or padding.
        </Paragraph>
      </Box>
    ),
  },
