  ...
  render: () => (
    <>
      <Paragraph size="lg" spacing>
        Typography is fundamental to good design. It creates hierarchy, organizes information, and
        makes content accessible.
      </Paragraph>
      <Paragraph spacing>
        The choice of typeface, size, spacing, and alignment all contribute to the overall reading
        experience. Proper typography enhances comprehension and keeps readers engaged.
      </Paragraph>
      <Paragraph size="sm" color="muted">
        Small text is perfect for captions, footnotes, or supplementary information that supports
        the main content without overwhelming it.
      </Paragraph>
    </>
  ),
};
...
export const CustomStyled: Story = {
  args: {
    children: "This paragraph uses the css prop for custom styling with token references.",
  },
  render: (args) => (
    <Paragraph
      {...args}
