...
/**
 * Centers children on one or both axes. `horizontal` and `vertical` default to true.
 */
const meta = {
  title: "Layout/Center",
  component: Center,
...
export const HorizontalOnly: Story = {
  args: {
    ...
    children: (
      ...
      >
        <Paragraph style={{ margin: 0 }}>Horizontally centered content</Paragraph>
      </Box>
    ),
  },
};
  ...
  render: () => (
    <Center horizontal vertical minHeight="400px">
      <Box style={{ textAlign: "center" }}>
        ...
        />
        <Paragraph style={{ margin: 0, fontFamily: "monospace", fontSize: "0.875rem" }}>
          LOADING...
        </Paragraph>
      </Box>
    </Center>
...
export const BrutalistCard: Story = {
  args: { children: null },
  render: () => (
    <Center horizontal vertical minHeight="500px" style={{ background: "transparent" }}>
      <Box
        style={{
      ...
      >
        ...
        >
          ...
          <Headline level={2} style={{ margin: 0, fontSize: "2rem", fontWeight: 600 }}>
          ...
          >
            🎀 ୧ꔛꗃ˖ Center component makes it easy to create perfectly centered layouts with modern
            aesthetics. Combine with other components for maximum impact ･ﾟ⋆
          </Paragraph>
        </Box>
      </Box>
    </Center>
