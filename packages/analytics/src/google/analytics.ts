 ...
 */
export function trackMediaPlay(mediaType: "video" | "audio", mediaUrl: string): void {
 ...
 */
export function trackHeaderInteraction(action: "menu_open" | "menu_close" | "logo_click"): void {
