...
/**
 * Scroll-triggered enter animation. Honours `prefers-reduced-motion`.
 */
const meta = {
    ...
    >
      ...
      <AnimateInView animation="slideInFromLeft" delay={0.2}>
        <Box css={{ p: "24px", bg: "neutral.200" }}>
          ...
          <Paragraph css={{ mt: "8px" }}>Slides from left with 0.2s delay</Paragraph>
        </Box>
      </AnimateInView>
      ...
      <AnimateInView animation="slideInFromRight" delay={0.4}>
        <Box css={{ p: "24px", bg: "neutral.300" }}>
          ...
          <Paragraph css={{ mt: "8px" }}>Slides from right with 0.4s delay</Paragraph>
        </Box>
      </AnimateInView>
      ...
      <AnimateInView animation="zoomIn" delay={0.6}>
        <Box css={{ p: "24px", color: "white", bg: "primary.500" }}>
          ...
          <Paragraph css={{ mt: "8px", color: "white" }}>Zooms in with 0.6s delay</Paragraph>
        </Box>
      </AnimateInView>
    </Box>
  ),
